...
// SAFE GEOAPIFY KEY – uses Vercel env var
const GEOAPIFY_KEY = process.env.REACT_APP_GEOAPIFY_KEY;

if (!GEOAPIFY_KEY) {
  console.error(
    "REACT_APP_GEOAPIFY_KEY is missing! Add it in Vercel Settings."
  );
}

// CO₂ emissions per km (EU standards)
const CO2_PER_KM = {
  car: 0.171,
  van: 0.25,
  truck: 0.85,
  ...
  const calculate = async () => {
    ...
    for (const row of data) {
      try {
        ...
        out.push({ ...row, Vehicle: vehicle, Distance: "Error", CO2: "Error" });
      }
    }
    setResults(out);
  ...
  return (
    <div className="container">
      ...
      <div className="faq">
        ...
        <details>
          <summary>Can I use my own emissions factors?</summary>
          <p>
            Not yet — but contact us for enterprise plans with custom factors.
          </p>
        </details>
        <details>
