...
function Home() {
      ...
      try {
        ...
        if (from && to) {
          ...
          if (r.ok) {
            ...
            out.push({ ...row, Vehicle: vehicle, Distance: "Error", CO2: "Error", CO2_Saved: "Error" });
          }
        } else {
          out.push({ ...row, Vehicle: vehicle, Distance: "Geocode failed", CO2: "Geocode failed", CO2_Saved: "Geocode failed" });
        }
      } catch {
        out.push({ ...row, Vehicle: vehicle, Distance: "Error", CO2: "Error", CO2_Saved: "Error" });
      }
  ...
  const download = () => {
    ...
    const ws = XLSX.utils.json_to_sheet(results.map(r => ({
      ...
      "CO2 Saved vs Truck (kg)": r.CO2_Saved.replace("+", "").replace(" kg", "")
    })));
    ...
    <div className="container">
      ...
      <div id="upload" className="upload">
        ...
        <div style={{ textAlign: "center", margin: "30px 0" }}>
          <p style={{ marginBottom: "15px", fontWeight: "600", fontSize: "1.1em" }}>
            ...
            {Object.entries(CO2_PER_KM).map(([key, value]) => (
              <label
                ...
                style={{
                  ...
                  boxShadow: vehicle === key ? "0 4px 8px rgba(0,123,255,0.2)" : "none"
                }}
              >
                <input
                  type="radio"
        ...
        <input
          ...
          style={{ display: "block", margin: "22px auto", padding: "12px", fontSize: "1em" }}
        />
      ...
      <div className="content">
        ...
        <ul>
          ...
          <li><strong>Real Estate</strong> – Show commute emissions to buyers</li>
        </ul>
      ...
      <div className="faq">
        ...
        <details>
          ...
          <p>We multiply driving distance by EU-standard emissions factors (e.g., 0.171 kg/km for cars).</p>
        </details>
        <details>
          <summary>Is my data secure?</summary>
          <p>Yes. Files are processed in memory and deleted immediately. GDPR compliant.</p>
        </details>
        <details>
          <summary>Why not use Google Maps?</summary>
          <p>Google limits bulk queries and requires paid API. Our tool has no limits.</p>
        </details>
      </div>
