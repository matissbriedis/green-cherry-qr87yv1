...
function App() {
  ...
  return (
    <div className="app">
      {/* HERO */}
      <header className="hero" style={{ textAlign: "center", padding: "60px 20px", background: "#f8f9fa" }}>
      ...
      <section className="content-section" style={{ padding: "60px 20px", maxWidth: "900px", margin: "0 auto", lineHeight: "1.7" }}>
        <h2 style={{ fontSize: "2em", color: "#2c3e50" }}>Why 10,000+ People Use This Tool Every Month</h2>
        <p>
          Imagine this: You have a spreadsheet with <strong>500 delivery addresses</strong>. You need to know the exact driving distance from your warehouse to each one. 
          Manually searching on Google Maps? That would take <em>days</em>.
        </p>
        <p>
          <strong>With Distances in Bulk, you do it in 30 seconds.</strong>
        </p>
        <p>
          Whether you're in <strong>logistics</strong>, <strong>e-commerce</strong>, <strong>real estate</strong>, or <strong>marketing</strong>, our tool saves you time, money, and headaches.
        </p>
        ...
        <ol style={{ fontSize: "1.1em" }}>
          ...
          <li><strong>Fill in "From" and "To"</strong> columns (e.g., "New York" → "Los Angeles").</li>
          <li><strong>Upload</strong> — we validate for free and show you the price.</li>
          <li><strong>Pay only if you need more than 10 rows</strong> ($0.10 per extra row).</li>
          <li><strong>Download your file</strong> with a new "Distance" column added.</li>
        </ol>

        <h3>Real-World Use Cases</h3>
        <ul style={{ listStyle: "inside", fontSize: "1.1em" }}>
          <li><strong>Delivery Companies</strong>: Optimize routes and estimate fuel costs.</li>
          <li><strong>E-commerce Stores</strong>: Calculate accurate shipping quotes.</li>
          <li><strong>Real Estate Agents</strong>: Show clients distance to schools, hospitals, and transit.</li>
          <li><strong>Marketing Teams</strong>: Map customer locations for targeted campaigns.</li>
          <li><strong>Travel Planners</strong>: Build itineraries with precise mileages.</li>
        </ul>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", margin: "20px 0" }}>
          <thead>
            <tr style={{ background: "#f1f3f5" }}>
              ...
              <th style={{ padding: "12px", textAlign: "left" }}>Google Maps</th>
              <th style={{ padding: "12px", textAlign: "left" }}><strong>Distances in Bulk</strong></th>
            </tr>
          </thead>
          <tbody>
            <tr>
        ...
        <p>
          From small startups to Fortune 500 logistics teams, our tool is the go-to solution for bulk distance calculation. 
        ...
        <div style={{ textAlign: "center", margin: "40px 0" }}>
          ...
          <button
            className="cta-button"
            style={{ fontSize: "1.3em", padding: "16px 40px" }}
      ...
      <section id="upload-section" className="upload-section" style={{ background: "#fff", padding: "50px 20px" }}>
        ...
        <div style={{ maxWidth: "600px", margin: "0 auto" }}>
          <input type="file" accept=".xlsx,.csv" onChange={handleFileUpload} disabled={isUploading} style={{ display: "block", margin: "20px auto" }} />
          {isUploading && (
            <div style={{ background: "#eee", height: "10px", borderRadius: "5px", overflow: "hidden", margin: "20px 0" }}>
            ...
            <div style={{ background: "#f8f9fa", padding: "20px", borderRadius: "8px", margin: "20px 0" }}>
              ...
              {error ? (
                ...
                <div>
                  ...
                  <p><strong>Price:</strong> {validation.price}</p>

                  {data.length > 10 + paidRows ? (
                    <div style={{ textAlign: "center", margin: "20px 0" }}>
                      <p style={{ color: "red", fontWeight: "bold" }}>Buy more rows to continue</p>
                      <div id="paypal-container-SZHCMQ36L2RAU"></div>
                    </div>
                  ) : (
                    <button className="cta-button" onClick={calculateDistances} disabled={isCalculating} style={{ width: "100%", marginTop: "15px" }}>
          ...
          {results.length > 0 && (
            <button className="cta-button" onClick={downloadResults} style={{ width: "100%", marginTop: "15px" }}>
              Download Results (Excel)
            </button>
          )}
          <button className="cta-button" onClick={handleDownloadTemplate} style={{ width: "100%", marginTop: "15px", background: "#6c757d" }}>
            Download Template
          </button>
        </div>
      </section>
      ...
      <section className="pricing" style={{ padding: "50px 20px", background: "#f8f9fa" }}>
        ...
        <table style={{ width: "100%", maxWidth: "600px", margin: "30px auto", borderCollapse: "collapse" }}>
          <tbody>
            <tr><td style={{ padding: "12px", borderBottom: "1px solid #ddd" }}>Validation & First 10 Rows</td><td style={{ padding: "12px", textAlign: "right", borderBottom: "1px solid #ddd" }}><strong>Free</strong></td></tr>
            <tr><td style={{ padding: "12px", borderBottom: "1px solid #ddd" }}>Additional Rows</td><td style={{ padding: "12px", textAlign: "right", borderBottom: "1px solid #ddd" }}>$0.10 each</td></tr>
            <tr>
              <td style={{ padding: "12px" }}>
                Buy 50 Rows
                <div id="paypal-container-SZHCMQ36L2RAU-pricing" style={{ marginTop: "8px" }}></div>
              </td>
              <td style={{ padding: "12px", textAlign: "right" }}><strong>$5.00</strong></td>
            </tr>
          </tbody>
        </table>
      </section>
